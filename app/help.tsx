    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}
        ...
        <View className='mt-5' style={{
            ...
            <View style={{
                flexDirection: 'row', alignItems: 'center', gap: 8,
                padding: 12, borderTopWidth: 0.5, borderTopColor: '#f4f4f5',
            }}>
                <View style={{
                ...
                <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 12, fontFamily: 'PoppinsMedium', color: '#18181b' }}>
                    FiScan — Full Tutorial
                </Text>
                <Text style={{ fontSize: 10, fontFamily: 'PoppinsRegular', color: '#a1a1aa' }}>
                    YouTube
                </Text>
                </View>
            </View>
