...
const Lesson2 = () => {
  return (
    <ScrollView showsVerticalScrollIndicator={false} className="flex-1 bg-white">
      ...
      <View style={{ width: "100%", height: 200, position: "absolute" }}>
        <Image
      ...
      <Text className="text-3xl mt-5 truncate text-zinc-600 px-5" style={{ fontFamily: 'PoppinsBold' }}>
      ...
      <View className='mx-5' style={{ borderWidth: 1, borderColor: '#e2e8f0', marginTop: 20, borderRadius: 15, overflow: 'hidden' }} >
        <Pressable onPress={() => router.push('/lessons/lesson3')} className='flex-row justify-between'>
            <Text className="p-3 text-2xl text-zinc-600 flex" style={{ fontFamily: 'PoppinsBold', zIndex: 10 }}>
                Next: Post-Drying & Storage
            </Text>
